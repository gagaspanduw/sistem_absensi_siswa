...
<?php 
    ...
    $sql1 = "SELECT * FROM tbl_kelas inner join tbl_user on tbl_kelas.nip = tbl_user.nip WHERE id_kelas='$param1'";
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="namakelas" id="namakelas" onchange="javascript:get(this)" required="required"> 
                            <option value="<?php echo $r1['nama_kelas']; ?>"><?php echo $r1['nama_kelas']; ?></option>
...
$insert = mysql_query("UPDATE tbl_kelas SET kelas='$kelas',nama_kelas='$namakelas',nip='$namaguru',tahun_ajaran='$tahun_ajaran',jurusan='$jurusan' where id_kelas=$param1");
if($insert){
